...
class Kentang_Explore extends StatefulWidget {
  const Kentang_Explore({Key key}) : super(key: key);

  @override
  _Kentang_ExploreState createState() => _Kentang_ExploreState();
}

// ignore: camel_case_types
class _Kentang_ExploreState extends State<Kentang_Explore> {
          ...
          Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipOval(
                  child: Image(
                    image: AssetImage('assets/images/kentang.jpg'),
                    width: 120,
                    height: 120,
                    alignment: Alignment.center,
                    fit: BoxFit.cover,
