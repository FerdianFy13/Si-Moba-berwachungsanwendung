...
class Moist_Soil extends StatefulWidget {
  const Moist_Soil({Key key}) : super(key: key);

  @override
  _Moist_SoilState createState() => _Moist_SoilState();
}

// ignore: camel_case_types
class _Moist_SoilState extends State<Moist_Soil> {
          ...
          Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipOval(
                  child: Image(
                    image: AssetImage('assets/images/moist.jpg'),
                    width: 120,
                    height: 120,
                    alignment: Alignment.center,
                    fit: BoxFit.cover,
